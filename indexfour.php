...
if(isset($_POST['username']) && isset($_POST['password'])){
	if(!empty($_POST['username']) && !empty($_POST['password'])){
		$username = @mysqli_real_escape_string($mysqli_con, $_POST['username']);//protecting against SQL injection
...
mysqli_close($mysqli_con);//closing the connection is important
